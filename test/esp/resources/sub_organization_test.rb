    ...
    context ESP::SubOrganization do
      context '#organization' do
        should 'call the api' do
          ...
          stub_org = stub_request(:get, %r{organizations/#{sub_organization.organization_id}.json_api*}).to_return(body: json(:organization))
      ...
      context '#teams' do
        should 'call the api' do
          ...
          stub_request(:get, /teams.json_api*/).to_return(body: json_list(:sub_organization, 2))
