module ESP
  class Api
    ...
    def define_methods
      ...
      end_points.each do |end_point|
        ...
        define_singleton_method name do
          ...
          instance_variable_set(:"@#{name}", ESP.const_get(end_point).new(config))
        end
    ...
    def options_errors(option)
      ENV["ESP_#{option.upcase}"] || fail(ESP::MissingAttribute, "Missing required #{option}")
    end
  end
end
